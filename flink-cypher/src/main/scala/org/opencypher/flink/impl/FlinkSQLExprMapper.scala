  ...
  implicit class RichExpression(expr: Expr) {
    ...
    private def convert(convertedChildren: Seq[Expression])
      ...
      expr match {
        ...
        case Cot(e) => Divide(IntegerLit(1), Tan(e))(CTFloat).asFlinkSQLExpr
        case _: Degrees => child0.degrees
        case Haversin(e) => Divide(Subtract(IntegerLit(1), Cos(e))(CTFloat), IntegerLit(2))(CTFloat).asFlinkSQLExpr
